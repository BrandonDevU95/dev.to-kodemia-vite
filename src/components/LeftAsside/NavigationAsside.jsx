...
export default function NavigationAsside() {
	return (
		<>
			<nav className="my-3">
				<ul className="list-group">
					<li className="list-group-item link-nav rounded border-0">
						<a
							href="#"
							...
							<span className="me-2">
								<svg
									...
									<g className="nc-icon-wrapper">
										...
										<path
											fill="#FFE8B6"
											d="M9 20L22 7l13 13v17H9z"></path>
										<path
											fill="#FFCC4D"
											d="M22 20h1v16h-1z"></path>
										<path
											fill="#66757F"
										...
										<path
											fill="#C1694F"
											d="M14 30h4v6h-4z"></path>
										<path
											fill="#55ACEE"
											d="M14 21h4v4h-4zm12.5 0h4v4h-4zm0 9h4v4h-4z"></path>
										<path
											fill="#5C913B"
							...
							<span className="me-2">
								<svg
									...
									<g className="nc-icon-wrapper">
										<path
											fill="#292F33"
											d="M10 19h24v2H10zm15 15c0 2.208-.792 4-3 4-2.209 0-3-1.792-3-4s.791-2 3-2c2.208 0 3-.208 3 2z"></path>
										<path
											fill="#66757F"
											d="M22 35c-6.627 0-10 1.343-10 3v2h20v-2c0-1.657-3.373-3-10-3z"></path>
										<path
											fill="#99AAB5"
											d="M22 4a9 9 0 00-9 9v7h18v-7a9 9 0 00-9-9z"></path>
										<g
											fill="#292F33"
										...
										<path
											fill="#66757F"
											d="M13 19.062V21c0 4.971 4.029 9 9 9s9-4.029 9-9v-1.938H13z"></path>
										<path
											fill="#66757F"
											d="M34 18a1 1 0 00-1 1v2c0 6.074-4.925 11-11 11s-11-4.926-11-11v-2a1 1 0 00-2 0v2c0 7.18 5.82 13 13 13s13-5.82 13-13v-2a1 1 0 00-1-1z"></path>
									</g>
								</svg>
							</span>
							Podcasts
							...
							<span className="me-2">
								<svg
									...
									<g className="nc-icon-wrapper">
										<path
											fill="#FFD983"
											d="M33 15.06c0 6.439-5 7.439-5 13.44 0 3.098-3.123 3.359-5.5 3.359-2.053 0-6.586-.779-6.586-3.361C15.914 22.5 11 21.5 11 15.06c0-6.031 5.285-10.92 11.083-10.92C27.883 4.14 33 9.029 33 15.06z"></path>
										<path
											fill="#CCD6DD"
											d="M26.167 36.5c0 .828-2.234 2.5-4.167 2.5-1.933 0-4.167-1.672-4.167-2.5 0-.828 2.233-.5 4.167-.5 1.933 0 4.167-.328 4.167.5z"></path>
										<path
											fill="#FFCC4D"
											d="M26.707 14.293a.999.999 0 00-1.414 0L22 17.586l-3.293-3.293a1 1 0 10-1.414 1.414L21 19.414V30a1 1 0 102 0V19.414l3.707-3.707a.999.999 0 000-1.414z"></path>
										<path
											fill="#99AAB5"
											d="M28 35a2 2 0 01-2 2h-8a2 2 0 01-2-2v-6h12v6z"></path>
										<path
											fill="#CCD6DD"
											d="M15.999 36a1 1 0 01-.163-1.986l12-2a.994.994 0 011.15.822.999.999 0 01-.822 1.15l-12 2a.927.927 0 01-.165.014zm0-4a1 1 0 01-.163-1.986l12-2a.995.995 0 011.15.822.999.999 0 01-.822 1.15l-12 2a.927.927 0 01-.165.014z"></path>
									</g>
								</svg>
							</span>
							DEV Help
						...
						<a
							...
							<span className="me-2">
								<svg
									...
									<path
										fill="#DD2E44"
										d="M39.885 15.833c0-5.45-4.418-9.868-9.867-9.868-3.308 0-6.227 1.633-8.018 4.129-1.791-2.496-4.71-4.129-8.017-4.129-5.45 0-9.868 4.417-9.868 9.868 0 .772.098 1.52.266 2.241C5.751 26.587 15.216 35.568 22 38.034c6.783-2.466 16.249-11.447 17.617-19.959.17-.721.268-1.469.268-2.242z"></path>
								</svg>
							</span>
							Advertise on DEV
						</a>
			...
			<nav className="mb-3">
				<h2 className="fw-bold fs-6 text-start px-3">Other</h2>
				<ul className="list-group">
					<li className="list-group-item link-nav rounded border-0">
						<a
							href="#"
							...
							<span className="me-2">
								<svg
									...
									<g transform="translate(4 4)">
										...
										<path
											fill="#664500"
											d="M27.335 23.629a.501.501 0 00-.635-.029c-.039.029-3.922 2.9-8.7 2.9-4.766 0-8.662-2.871-8.7-2.9a.5.5 0 10-.729.657C8.7 24.472 11.788 29.5 18 29.5s9.301-5.028 9.429-5.243a.499.499 0 00-.094-.628z"></path>
										<path
											fill="#65471B"
											d="M18 26.591c-.148 0-.291-.011-.438-.016v4.516h.875v-4.517c-.145.005-.289.017-.437.017z"></path>
										<path
											fill="#FFF"
											d="M22 26c.016-.004-1.45.378-2.446.486-.366.042-.737.076-1.117.089v4.517H20c1.1 0 2-.9 2-2V26zm-8 0c-.016-.004 1.45.378 2.446.486.366.042.737.076 1.117.089v4.517H16c-1.1 0-2-.9-2-2V26z"></path>
										<path
											fill="#65471B"
							...
							<span className="me-2">
								<svg
									...
									<g transform="translate(4 4)">
										...
										<path
											fill="#E1E8ED"
											d="M8.828 32.031C3.948 32.031.125 25.868.125 18S3.948 3.969 8.828 3.969 17.531 10.132 17.531 18s-3.823 14.031-8.703 14.031zm0-26.562C4.856 5.469 1.625 11.09 1.625 18s3.231 12.531 7.203 12.531S16.031 24.91 16.031 18 12.8 5.469 8.828 5.469z"></path>
										<circle
											fill="#8899A6"
											cx="6.594"
											cy="18"
										...
										<path
											fill="#E1E8ED"
											d="M27.234 32.031c-4.88 0-8.703-6.163-8.703-14.031s3.823-14.031 8.703-14.031S35.938 10.132 35.938 18s-3.824 14.031-8.704 14.031zm0-26.562c-3.972 0-7.203 5.622-7.203 12.531 0 6.91 3.231 12.531 7.203 12.531S34.438 24.91 34.438 18 31.206 5.469 27.234 5.469z"></path>
										<circle
											fill="#8899A6"
											cx="25"
											cy="18"
			...
			<div className="d-flex justify-content-evenly mb-3">
				<a href="#" className="p-2 social-icon rounded">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="24"
						height="24"
						...
						<title id="aak7bnft0zw8hqydxydl2l91fy1n86yr">
							Twitter
						</title>
						<g id="surface1">
							<path
				...
				<a href="#" className="p-2 social-icon rounded">
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby="aooak5qd7p9x0n8oari3b3xv5cjguo6b"
						className="crayons-icon c-link__icon">
						<title id="aooak5qd7p9x0n8oari3b3xv5cjguo6b">
							Facebook
						</title>
				...
				<a href="#" className="p-2 social-icon rounded">
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby="apkvlnaorwg8fir3ckrmwok5rzvnxobn"
						className="crayons-icon c-link__icon">
						<title id="apkvlnaorwg8fir3ckrmwok5rzvnxobn">
							Github
						</title>
				...
				<a href="#" className="p-2 social-icon rounded">
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby="a31c1cvuwu4y8sgs2p7xwbsw0lffjvf5"
						className="crayons-icon c-link__icon">
						<title id="a31c1cvuwu4y8sgs2p7xwbsw0lffjvf5">
							Instagram
						</title>
				...
				<a href="#" className="p-2 social-icon rounded">
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby="ahe9pq4bnbx6ej38g80zg7ardk56kkdm"
						className="crayons-icon c-link__icon">
						<title id="ahe9pq4bnbx6ej38g80zg7ardk56kkdm">
							Twitch
						</title>
				...
				<a href="#" className="p-2 social-icon rounded">
					<svg
						...
						viewBox="0 0 24 24"
						role="img"
						aria-labelledby="arvh2dnwxse2h0ueico9qrfzpirjrdbx"
						className="crayons-icon c-link__icon">
						<title id="arvh2dnwxse2h0ueico9qrfzpirjrdbx">
							Mastodon
						</title>
